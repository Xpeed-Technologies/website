...
<body class="body">
    <section id="preloader" class="uk-position-fixed uk-height-1-1 uk-width-1-1 uk-position-top-left uk-background-muted uk-flex uk-flex-middle uk-flex-center uk-hidden" style="z-index: 99">
